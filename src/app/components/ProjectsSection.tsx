      ...
      <div className="lg:w-2/3 mx-auto">
        <div className="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative mb-4 ">
          ...
          <div className="text-center relative w-full">
            ...
            <Link target="blank" href="https://blog-giaic.vercel.app/?vercelToolbarCode=5ySl1VeFcdF9FfK">check this out!</Link>
            </button>
              </div>
                </div>
          ...
          <div className="px-2 w-1/2">
            <div className="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
              ...
              <div className="text-center relative w-full">
                ...
                Its a Simple Static resume with Education,Skills,Experience section.
                </p>
                <button className="mt-3 text-indigo-500 inline-flex items-center">
              <Link target="blank" href="https://static-interactive-resume-builder-eosin.vercel.app/"> check this out!</Link>
            </button>
              </div>
            </div>
          </div>
          ...
          <div className="px-2 w-1/2">
            <div className="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
              ...
              <div className="text-center relative w-full">
                ...
                <p className="leading-relaxed">
                Its a Editable resume with Education,Skills,Experience section with download & shareable link.</p>
                <button className="mt-3 text-indigo-500 inline-flex items-center">
               <Link target="blank" href="https://editable-resume-xi.vercel.app/"> check this out!</Link>
                </button>
              </div>
            </div>
          </div>
